...
public class Deck {
	...
	/**
	 * this class represent a deck of cards with multiple ways
	 * to combine/ create a deck of cards ,
	 * the user can :
	 * 	# take a card
	 * 	# get the number of cards in the deck
	 *  # print the cards in the deck
	 *  # and sort the deck by number then suit
	 * 
	 */
	...
	public Deck(int num) {
		/**
		 * build a deck by combining each card from number 0-number-1
		 * with every suit
		 */
	...
	public Deck(Deck from, int num) {
		/**
		 * take the num amount of cards from the deck from and
		 * puts them in out current deck 
		 */
	...
	public Deck(Deck first, Deck second) {
		/**
		 * takes the cards from two decks each time 
		 * from each deck 
		 * till they are both empty 
		 */
		boolean flag = true;
		int i;
